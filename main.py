...
class JournalRAG:
    def __init__(self, journal_dir: str, db_path: str = "diary_embeddings.db",
    ...
    def build_index(self, force_rebuild: bool = False):
        ...
        if existing_count > 0 and not force_rebuild:
            print(f"Index already exists with {existing_count} entries. Use force_rebuild=True to rebuild.")
            conn.close()
            return
    ...
    def _similarity_search(self, query: str, top_k: int = 5) -> List[Tuple[str, str, str, float]]:
